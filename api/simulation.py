...
def point_in_existing_spheres(pt, t, spheres):
    """
    Check if a point is inside any existing sphere at time t.
    """
...
def estimate_free_volume_fraction(t, spheres, n_samples=n_free_mc):
    """
    Estimate free volume fraction via Monte Carlo sampling.
    """
...
def run_simulation():
    """
    Runs the sphere nucleation simulation and returns results.
    """
    spheres = []
    t = 0.0
    results = []
